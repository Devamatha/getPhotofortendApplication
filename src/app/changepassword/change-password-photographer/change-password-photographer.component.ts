...
@Component({
  selector: 'app-change-password-photographer',
  templateUrl: './change-password-photographer.component.html',
  styleUrl: './change-password-photographer.component.css'
})
export class ChangePasswordPhotographerComponent {
  getallData: any;
  ...
  changePassword() {
    ...
    this.registrionAndLoginServiceService
      .getbyPhotographerId(localStorage.getItem('photographer_Id'))
      .subscribe((response) => {
    ...
    if (this.changePasswordForm.valid) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          let adminId = localStorage.getItem('photographer_Id');
